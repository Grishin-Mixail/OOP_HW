...
def get_number_rows(ai_settings, ship_heigth, alien_heigth):
	...
	available_space_y = (ai_settings.screen_heigth - (2 * alien_heigth) - ship_heigth)
	number_rows = int(available_space_y / (1 * ship_heigth))
	return number_rows
...
def update_bullets(ai_settings, screen, ship, stats, sb, aliens, bullets):
	...
	check_bullet_alien_collisions(ai_settings, screen, ship, stats, sb,
		aliens, bullets)
	
			
def check_bullet_alien_collisions(ai_settings, screen, ship, stats, sb, 
	aliens, bullets):
